        ...
        <div className="flex justify-between items-center py-4">
          ...
          <div className="flex items-center space-x-4">
            ...
            <button
              ...
              className="p-2 rounded-lg hover:bg-gray-200 transition-colors md:hidden"
            >
              {isMobileMenuOpen ? (
          ...
          <div className="md:hidden py-4">
            <div className="space-y-2">
              <button
                ...
                className="w-full flex items-center space-x-2 px-4 py-2 text-sm text-gray-800 hover:bg-gray-200 rounded-lg"
              >
                <Settings size={16} />
                <span>Settings</span>
              </button>
              <button
                ...
                className="w-full flex items-center space-x-2 px-4 py-2 text-sm text-red-600 hover:bg-gray-200 rounded-lg"
              >
                <LogOut size={16} />
                <span>Logout</span>
              </button>
